    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Checkout(OrderModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                SaveOrderWithoutPayment(model, userId);
        ...
        private void SaveOrderWithoutPayment(OrderModel model, string userId)
        {
            var order = new Order();
            ...
            order.PaymentId = string.Empty;
            order.PaymentToken = string.Empty;
            order.ConversationId = string.Empty;
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-GmGSPoSXmDVH6SdLDUmUuMDHuhAAZNip";
            options.SecretKey = "sandbox-bKwrNLmGrPDYJyHH5leRq4On0arh3GDy";
            options.BaseUrl = "https://sandbox-merchant.iyzipay.com/";
